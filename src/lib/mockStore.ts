...
const seed = (): State => ({
  articles: [
    { id: "1", title: "الجزائر تطلق مشروعاً ضخماً للطاقة المتجددة بقدرة ٥ غيغاواط", excerpt: "أعلنت الحكومة الجزائرية عن إطلاق أكبر مشروع للطاقة الشمسية في إفريقيا.", body: "أعلنت الحكومة الجزائرية اليوم عن إطلاق أكبر مشروع للطاقة الشمسية في القارة الإفريقية، بقدرة إنتاجية تبلغ ٥ غيغاواط.\n\n## الأهداف الاستراتيجية\n\nيأتي هذا المشروع في إطار استراتيجية التنويع الاقتصادي للتقليل من الاعتماد على المحروقات.\n\nوأوضح وزير الطاقة أن المشروع سيُنجز على ثلاث مراحل خلال السنوات الخمس المقبلة، وسيوفر أكثر من ٢٠ ألف فرصة عمل.\n\n## الإمكانات الطبيعية\n\nتمتلك الجزائر واحداً من أعلى معدلات الإشعاع الشمسي في العالم، مما يجعلها موقعاً مثالياً.", image_url: heroImg, category: "الجزائر", category_key: "algeria", author: "محمد بن علي", status: "published", is_breaking: true, is_featured: true, is_premium: false, fact_check: "verified", sources: [{ title: "وزارة الطاقة الجزائرية", url: "https://www.energy.gov.dz" }, { title: "Reuters — Algeria solar push", url: "https://www.reuters.com" }], tags: ["طاقة", "الجزائر", "اقتصاد"], view_count: 1240, created_at: hoursAgo(2), published_at: hoursAgo(2) },
    { id: "2", title: "البرلمان يصادق على قانون الاستثمار الجديد لجذب رؤوس الأموال الأجنبية", excerpt: "في جلسة تاريخية، صادق البرلمان على قانون الاستثمار المعدّل.", body: "في جلسة تاريخية، صادق البرلمان الجزائري على قانون الاستثمار المعدّل الذي يمنح تسهيلات غير مسبوقة للمستثمرين.\n\nويتضمن القانون الجديد مزايا ضريبية واسعة وتبسيط الإجراءات الإدارية للمستثمرين الأجانب.\n\n## النقاط الأساسية\n\nأبرز ما جاء في القانون هو إلغاء قاعدة 51/49 في عدد من القطاعات غير الاستراتيجية، وإنشاء وكالة وطنية للاستثمار بصلاحيات موسّعة.", image_url: politicsImg, category: "اقتصاد", category_key: "economy", author: "فاطمة الزهراء", status: "published", is_breaking: false, is_featured: false, is_premium: true, fact_check: "analysis", sources: [{ title: "الجريدة الرسمية", url: "https://www.joradp.dz" }], tags: ["اقتصاد", "استثمار"], view_count: 870, created_at: hoursAgo(3), published_at: hoursAgo(3) },
    { id: "3", title: "الجزائر تحتضن أكبر مؤتمر تكنولوجي في شمال إفريقيا", excerpt: "تستعد العاصمة لاحتضان مؤتمر التحول الرقمي بمشاركة ٥٠٠ شركة.", body: "تستعد العاصمة الجزائرية لاحتضان مؤتمر التحول الرقمي الذي يجمع أكثر من ٥٠٠ شركة تقنية من حول العالم.", image_url: techImg, category: "تكنولوجيا", category_key: "tech", author: "أحمد كريم", status: "published", is_breaking: false, is_featured: false, is_premium: false, fact_check: "none", sources: [], tags: ["تكنولوجيا", "رقمنة"], view_count: 540, created_at: hoursAgo(5), published_at: hoursAgo(5) },
    { id: "4", title: "المنتخب الوطني يحقق فوزاً تاريخياً في تصفيات كأس العالم ٢٠٢٦", excerpt: "حقق الخضر فوزاً ساحقاً بثلاثية نظيفة في مباراة مصيرية.", body: "حقق المنتخب الوطني الجزائري فوزاً ساحقاً بثلاثة أهداف مقابل لا شيء في المباراة المصيرية.", image_url: sportsImg, category: "رياضة", category_key: "sports", author: "ياسين حداد", status: "published", is_breaking: false, is_featured: false, is_premium: false, fact_check: "verified", sources: [{ title: "FAF — Fédération Algérienne de Football", url: "https://www.faf.dz" }], tags: ["رياضة", "كرة القدم"], view_count: 2310, created_at: hoursAgo(7), published_at: hoursAgo(7) },
    { id: "5", title: "ارتفاع احتياطي الصرف الأجنبي للجزائر إلى مستويات قياسية", excerpt: "كشف بنك الجزائر عن ارتفاع ملحوظ في احتياطيات النقد الأجنبي.", body: "كشف بنك الجزائر عن ارتفاع ملحوظ في احتياطيات النقد الأجنبي للبلاد، حيث بلغت مستويات لم تشهدها منذ عدة سنوات.\n\n## القراءة الاقتصادية\n\nيُعزى هذا الارتفاع إلى تحسّن أسعار المحروقات وانضباط ميزان المدفوعات.", image_url: economyImg, category: "اقتصاد", category_key: "economy", author: "فاطمة الزهراء", status: "published", is_breaking: false, is_featured: false, is_premium: true, fact_check: "verified", sources: [{ title: "بنك الجزائر — تقرير الاحتياطيات", url: "https://www.bank-of-algeria.dz" }], tags: ["اقتصاد", "بنك"], view_count: 410, created_at: hoursAgo(10), published_at: hoursAgo(10) },
    { id: "6", title: "مهرجان تيمقاد الدولي يعود بنسخته الجديدة بحضور فنانين عالميين", excerpt: "يعود مهرجان تيمقاد الدولي للموسيقى بنسخة استثنائية.", body: "يعود مهرجان تيمقاد الدولي للموسيقى بنسخة استثنائية هذا العام، حيث يستضيف المهرجان فنانين من أكثر من ٢٠ دولة.", image_url: cultureImg, category: "ثقافة", category_key: "culture", author: "نادية بوعزيز", status: "published", is_breaking: false, is_featured: false, is_premium: false, fact_check: "opinion", sources: [], tags: ["ثقافة", "موسيقى"], view_count: 290, created_at: hoursAgo(24), published_at: hoursAgo(24) },
  ],
  comments: [
